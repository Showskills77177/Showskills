...
function buildCoreUi() {
  return {
    ...
    'auth.loginIntro': 'Sign in to your ShowSkills Rewards account.',
    'auth.registerTitle': 'Create account',
    'auth.registerIntro':
      'Create a free account to manage your entries and stay in touch with ShowSkills Rewards.',
    'auth.registerNewsletterNote':
      'By creating an account you are automatically subscribed to our newsletter. You can change email preferences anytime from the link in our emails.',
    ...
    'auth.newsletterSubscribed': 'You are subscribed to ShowSkills Rewards email updates.',
    'auth.entryHistory': 'Your entries',
    'auth.entryHistoryIntro': 'Paid ticket purchases linked to this account. Complete any pending skill quiz to qualify for the draw.',
    'auth.noEntries': 'No paid entries yet for this account. Purchases made with the same email will appear here.',
    'auth.loadingEntries': 'Loading your entries…',
    'auth.entryOrderRef': 'Order',
    'auth.entryPurchased': 'Purchased',
    'auth.entryTickets': '{count} tickets',
    'auth.ticketsLabel': 'Tickets',
    'auth.profileSettings': 'Profile settings',
    'auth.profilePageIntro': 'Manage your details, newsletter preferences, and view your competition entries.',
    'auth.helpAndLegal': 'Help & legal',
    'auth.helpAndLegalIntro': 'FAQ and full terms are available here when you need them.',
    'auth.profileDetails': 'Account details',
    'auth.mobile': 'Mobile',
    ...
    'auth.newsletterToggle': 'Newsletter emails',
    'auth.newsletterToggleHint': 'ShowSkills Rewards updates about giveaways and competitions.',
    'auth.newsletterOn': 'Newsletter subscription turned on.',
    'auth.newsletterOff': 'Newsletter subscription turned off.',
    'auth.quizPending': 'Skill quiz pending',
    'auth.quizQualified': 'Qualified for draw',
    'auth.quizNotQualified': 'Quiz completed — not qualified',
    'auth.completeQuiz': 'Complete skill quiz',
    'auth.viewCompetitions': 'Enter a competition',
    'auth.manageNewsletter': 'Newsletter preferences',
    ...
    'auth.forgotPasswordIntro':
      'Enter the email for your ShowSkills Rewards account. We will send a 6-digit code if an account exists.',
    'auth.sendResetCode': 'Send reset code',
    'auth.sendingResetCode': 'Sending…',
    'auth.resetPasswordTitle': 'Choose a new password',
    'auth.resetPasswordIntro': 'Enter the 6-digit code from your email and your new password.',
    'auth.resetCode': 'Reset code',
    'auth.resetCodeHint': '6-digit code from your email',
