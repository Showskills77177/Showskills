...
import editorTestLogin from '../backend/api/editor-test-login.js'
import editorTestLogout from '../backend/api/editor-test-logout.js'
import editorTestMe from '../backend/api/editor-test-me.js'
...
export const routes = {
  ...
  '/api/editor-test-login': editorTestLogin,
  '/api/editor-test-logout': editorTestLogout,
  '/api/editor-test-me': editorTestMe,
