...
import adminEofProduction from '../backend/api/admin/eof-production.js'
import adminEofProductionAudio from '../backend/api/admin/eof-production-audio.js'
import adminEofProductionVideo from '../backend/api/admin/eof-production-video.js'
import adminEofProductionSceneImage from '../backend/api/admin/eof-production-scene-image.js'
...
import adminEofScriptMaker from '../backend/api/admin/eof-script-maker.js'
import eofDailyCron from '../backend/api/eof-daily-cron.js'
import eofScriptMakerCron from '../backend/api/eof-script-maker-cron.js'
...
export const routes = {
  ...
  '/api/admin/eof-production': adminEofProduction,
  '/api/admin/eof-production-audio': adminEofProductionAudio,
  '/api/admin/eof-production-video': adminEofProductionVideo,
  '/api/admin/eof-production-scene-image': adminEofProductionSceneImage,
  '/api/admin/eof-music-tracks': adminEofMusicTracks,
  '/api/admin/eof-scheduler': adminEofScheduler,
  '/api/admin/eof-script-maker': adminEofScriptMaker,
  '/api/eof-daily-cron': eofDailyCron,
  '/api/eof-script-maker-cron': eofScriptMakerCron,
