...
export const routes = {
  ...
  '/api/admin/eof-production': lazyDefault(() => import('../backend/api/admin/eof-production.js')),
  '/api/admin/eof-production-audio': lazyDefault(() => import('../backend/api/admin/eof-production-audio.js')),
  '/api/admin/eof-production-video': lazyDefault(() => import('../backend/api/admin/eof-production-video.js')),
  ...
  '/api/admin/eof-script-maker': lazyDefault(() => import('../backend/api/admin/eof-script-maker.js')),
  '/api/eof-daily-cron': lazyDefault(() => import('../backend/api/eof-daily-cron.js')),
  '/api/eof-script-maker-cron': lazyDefault(() => import('../backend/api/eof-script-maker-cron.js')),
