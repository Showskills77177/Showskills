...
import adminSendEmail from '../backend/api/admin/send-email.js'
...
import {
  startRonaldoShirtQuizSession,
  submitRonaldoShirtQuiz,
} from '../backend/api/submissions/ronaldo-shirt-quiz.js'
...
export const routes = {
  ...
  '/api/admin/send-email': adminSendEmail,
  ...
  '/api/submissions/ronaldo-shirt-quiz/start': startRonaldoShirtQuizSession,
  '/api/submissions/ronaldo-shirt-quiz/submit': submitRonaldoShirtQuiz,
