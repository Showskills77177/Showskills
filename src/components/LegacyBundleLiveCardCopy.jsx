...
export function LegacyBundleLiveCardCopy({
  ...
  return (
    <div className="ss-competition-card-legacy-stack">
      ...
      <p className="ss-competition-card-legacy-stack__price inline-flex w-fit rounded-lg border border-emerald-400/30 bg-emerald-950/35 px-3 py-1.5 text-base font-display text-emerald-50 md:text-sm lg:text-base">
